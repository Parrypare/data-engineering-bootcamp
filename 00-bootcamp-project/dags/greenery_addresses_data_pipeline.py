...
def _load_data_to_gcs(ds):
    keyfile_gcs = "/opt/airflow/dags/triple-zenith-load-file-to-gcs414518-799ea839daaa.json"
...
def _load_data_from_gcs_to_bigquery():
    keyfile_bigquery = "/opt/airflow/dags/dataengineercafe-deb3-load-files-to-bigquery73ea5a4113c0.json"
